...
#define DRV_MODULE_NAME		"xdma_test"
#define DRV_MODULE_DESC		"Xilinx XDMA Reference Driver"

//static char version[] = DRV_MODULE_DESC " " DRV_MODULE_NAME " v" DRV_MODULE_VERSION "\n";
